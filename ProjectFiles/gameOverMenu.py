...
class Menu_TextItem:
    def __init__(self, name, text="notext", textSize=100, mainColor=(128, 128, 128), onMouseOverColor=(128, 150, 150),
        ...
        self.isMouseOver = False  # mouse is over
        self.state = 0  # mouse state for color changing
        self.mouseDownEvent = pygame.event.Event(pygame.USEREVENT, {self.name: "mouseDownEvent"})
        self.mouseUpEvent = pygame.event.Event(pygame.USEREVENT, {self.name: "mouseUpEvent"})
...
class gameOverMenu:
    ...
    def runGameOverMenu(self, screen):
        self.reset_state()
        self.isActive = True
        ...
        while self.isActive:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    pygame.event.post(gameOverMenu.Restart_Event)
                    return False
