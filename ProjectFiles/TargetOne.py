...
class TargetOne:
    def __init__(self,screen):
        ...
        self.flyImage = (pygame.transform.scale(pygame.image.load("images/png/Bombs/Bomb_1_Idle (1).png"),(self.rectangle[2],self.rectangle[3])))
    ...
    def hit(self):
        ...
        if self.life<=0:
            self.explode()
            print("t1 ammo before:", Plane.ammo)
            Plane.ammo += 5
            ScoreBoard.score += 10
            print("t1 ammo after:", Plane.ammo)
